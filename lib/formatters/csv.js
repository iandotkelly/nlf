...
const heading = 'name,version,directory,repository,summary,from package.json,from license,from readme'
...
function recordToCsv (moduleRecord) {
  ...
  return `${moduleRecord.name},${moduleRecord.version},${moduleRecord.directory},${moduleRecord.repository},${moduleRecord.summary().join(';')},${moduleRecord.licenseSources.package.summary().join(';')},${moduleRecord.licenseSources.license.summary().join(';')},${moduleRecord.licenseSources.readme.summary().join(';')}`
}
