...
/**
 * Add LicenseCollection
 */
Module.prototype.getLicenseCollection = function (name) {
	var licenseCollection = this.licenseSources[name];
	if (!licenseCollection) {
		licenseCollection = new LicenseCollection();
		this.licenseSources[name] = licenseCollection;
	}
